...
def recommend_club(req: RecommendRequest, db: Session = Depends(get_db)):
    ...
    prompt = (
        ...
        "player's NEXT shot.\n\n"
        "Use the player's history, hole context, current weather, and "
        "available clubs to select one club and estimate dynamic_yardage.\n\n"
        "dynamic_yardage means:\n"
        "The predicted distance this specific player will hit the recommended "
        "club on this shot, after adjusting their historical distance for "
        "current weather, altitude, lie, and course conditions.\n\n"
        "Inputs:\n\n"
        "PLAYER PROFILE:\n" + "\n".join(profile_lines) + "\n\n"
        "HOLE CONTEXT:\n" + "\n".join(hole_lines) + "\n\n"
        ...
        "- Recommend the club with the best balance of predicted distance, "
        "consistency, and risk avoidance.\n"
